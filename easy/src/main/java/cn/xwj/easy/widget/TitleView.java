...
public class TitleView extends RelativeLayout {
    ...
    private void initAttrs() {
        TypedArray typedArray = mContext.obtainStyledAttributes(mAttrs, cn.xwj.easy.R.styleable.TitleView);
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(cn.xwj.easy.R.layout.title_layout, this, true);
        mToolbar = (Toolbar) view.findViewById(cn.xwj.easy.R.id.tool_bar);
        mTitle = (TextView) view.findViewById(cn.xwj.easy.R.id.title_text);
        mToolbar.setTitle("");
    }
