...
public class NoticeAngle extends RelativeLayout {
    ...
    public NoticeAngle(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        RelativeLayout rl = (RelativeLayout) LayoutInflater.from(context).inflate(cn.xwj.easyutil.R.layout.notice_angle, this, true);
        bar_num = (TextView) rl.findViewById(cn.xwj.easyutil.R.id.tv_notice_angle);
        bar_image = (ImageView) rl.findViewById(cn.xwj.easyutil.R.id.iv_icon);
